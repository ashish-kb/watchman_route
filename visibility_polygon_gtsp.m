...
environment = read_vertices_from_file('example1.environment');%'example2_modified.environment'
...
%     end
    ...
    %Plot observer
     observer_x  = 0.708114640883976; 
     observer_y = [1.61930248618784];
    ...
    patch( V{1}(:,1) , V{1}(:,2) , 0.1*ones( size(V{1},1) , 1 ) , ...
     ...
     observer_x  = [4.81944060773481]; 
     observer_y = [0.107285911602208];  
    ...
    patch( V{1}(:,1) , V{1}(:,2) , 0.1*ones( size(V{1},1) , 1 ) , ...
     ...
     observer_x  = [7.91142955801105]; 
     observer_y = [0.922755524861877];  
    ...
    patch( V{1}(:,1) , V{1}(:,2) , 0.1*ones( size(V{1},1) , 1 ) , ...
     ...
     observer_x  = [7.70756215469614]; 
     observer_y = [4.54140193370166];  
