function vertexSequenceOrdered = get_concorde_result(symtsp,setSorted)
...
cmd = ['/home/ashishkb/softwares/concorde/concorde/LINKERN/linkern -o superChargerTSPSolution.txt superchargerTSP.txt'];
