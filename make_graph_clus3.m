...
G_comp.Nodes.Cluster{1} = [1, 2];
G_comp.Nodes.Cluster{2} = [2, 3];
G_comp.Nodes.Cluster{3} = [2, 3];
...
% {'1;A,1-1';'2;A,1-1';'3;A,1-1';'1;C,1-1';'2;C,1-1';'3;C,1-1';'1;A,3-3';'2;A,3-3';'3;A,3-3';'1;B,3-3';'2;B,3-3';'3;B,3-3';'1;e-3';'2;e-3';'3;e-3';'1;C,3-3';'2;C,3-3';'3;C,3-3';'1;A,3-2';'2;A,3-2';'3;A,3-2';'1;B,3-2';'2;B,3-2';'3;B,3-2';'1;e-2';'2;e-2';'3;e-2';'1;C,2-2';'2;C,2-2';'3;C,2-2';'1;B,2-2';'2;B,2-2';'3;B,2-2';'1;A,2-2';'2;A,2-2';'3;A,2-2';'1;C,3-2';'2;C,3-2';'3;C,3-2'}
%             V1-1                                           ->                        V3-3                          ->                                                                    V3-2                   ->                                                                 V2-2                         ->                                                V3-2 ->                           V1-1   

%%%             V1-1    ->   V3-3    ->    V3-2     ->       V2-2 -> V3-2             ->       V1-1      order ca=> ac for node 1 is reverse?            %
